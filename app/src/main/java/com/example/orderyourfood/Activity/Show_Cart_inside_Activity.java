...
public class Show_Cart_inside_Activity extends AppCompatActivity {
    ...
    private void getBundle() {
        object=(RiceDomain) getIntent().getSerializableExtra("object");
