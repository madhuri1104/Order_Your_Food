...
public class TinyDB {
    ...
    public ArrayList<String> getListString_rice(String key) {
        ArrayList<RiceDomain> playerList =  new ArrayList<RiceDomain>();
        return new ArrayList<String>(Arrays.asList(TextUtils.split(preferences.getString(key, ""), "â€šâ€—â€š")));
    }
    ...
    public ArrayList<RiceDomain> getListObject_rice(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString_rice(key);
        ArrayList<RiceDomain> playerList =  new ArrayList<RiceDomain>();

        for(String jObjString : objStrings){
            RiceDomain player  = gson.fromJson(jObjString,  RiceDomain.class);
            playerList.add(player);
        }
        return playerList;
    }
    ...
    public void putListObject_rice(String key, ArrayList<RiceDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(RiceDomain player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
